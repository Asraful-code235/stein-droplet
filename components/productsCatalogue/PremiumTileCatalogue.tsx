...
import marbleImg from "@/assets/tile1.png";
import graniteImg from "@/assets/tile2.png";
import limestoneImg from "@/assets/tile3.png";
import limestoneImg1 from "@/assets/tile4.png";

const PremiumTileCatalogue = ({ data }: any) => {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-inter text-[#101820] mb-6">
            Ceramic<span className="text-[#CB7856] ml-3">Tiles</span>
          </h1>
          <p className="text-xl text-[#101820] font-sans max-w-3xl mx-auto">
            Advanced ceramic and porcelain tiles with innovative designs and
...
export default PremiumTileCatalogue;
