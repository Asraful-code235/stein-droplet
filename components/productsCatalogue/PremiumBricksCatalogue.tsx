      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-inter text-[#101820] mb-6">
            Premium<span className="text-[#CB7856] ml-3">Ceramics</span>
          </h1>
          <p className="text-xl text-[#101820] font-sans max-w-3xl mx-auto">
            High-quality brick collections combining traditional craftsmanship{" "}
            <br /> with modern performance standards.
          </p>
        </div>
...
export default PremiumBricksCatalogue;
